				...
				if(typeof res['data'][index]!='undefined'){
					...
					tx.executeSql(q, [res['data'][index]['id']], function(tx, rest){
						if(parseInt(rest.rows.length)>0){
							var qr="UPDATE wnh_emergency_notifications SET emergency_id='"+res['data'][index]['emergency_id']+"', notification_type='"+res['data'][index]['notification_type']+"', notification_for='"+res['data'][index]['notification_for']+"', clinic_id='"+res['data'][index]['clinic_id']+"', manager_id='"+res['data'][index]['manager_id']+"', company_id='"+res['data'][index]['company_id']+"', readbycompany='"+res['data'][index]['readbycompany']+"', readbymanager='"+res['data'][index]['readbymanager']+"', notify='"+res['data'][index]['notify']+"' WHERE emergency_notification_id='"+res['data'][index]['id']+"'";
							//alert(qr);
							tx.executeSql(qr);	
						}
						else{
							var qr='INSERT INTO wnh_emergency_notifications (emergency_notification_id, emergency_id, manager_id, company_id, clinic_id, cdate, readbycompany, readbymanager, notification_for, notification_type, notify) VALUES ("'+res['data'][index]['id']+'", "'+res['data'][index]['emergency_id']+'", "'+res['data'][index]['manager_id']+'", "'+res['data'][index]['company_id']+'", "'+res['data'][index]['clinic_id']+'", "'+res['data'][index]['cdate']+'", "'+res['data'][index]['readbycompany']+'", "'+res['data'][index]['readbymanager']+'", "'+res['data'][index]['notification_for']+'", "'+res['data'][index]['notification_type']+'", "'+res['data'][index]['notify']+'")';
